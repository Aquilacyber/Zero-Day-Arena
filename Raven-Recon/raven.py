...
def display_title_screen():
    print(Fore.CYAN + "========================================================================")
    print("       WELCOME TO 'ZERO-DAY-ARENA Raven Recon': The Penetration Testing Simulation      ")
    print("========================================================================" + Style.RESET_ALL)
    print("Created by: AquilaCyber")
    print("Special thanks: milosilo")
    print("Twitter: @aquila_cyber")
...
def host_one():
    ...
    while True:
        ...
        cmd = "ifconfig"
        user_input = input("aquila@raven:~$ ")
        if user_input.strip() == cmd:
            print(Fore.GREEN + "Output: inet 192.168.1.100  netmask 255.255.255.0" + Style.RESET_ALL)
            print("Aquila Cyber salutes your precision! Now proceed to scan the target host.")
            ...
            if user_input.strip() == cmd:
                ...
                print(Fore.RED + "Access Denied by Aquila Cyber! Refine Your Tactics!" + Style.RESET_ALL)
        else:
            print(Fore.RED + "Access Denied by Aquila Cyber! Refine Your Tactics!" + Style.RESET_ALL)
...
def host_four():
    ...
    while True:
        ...
        if user_input.strip() == cmd:
            ...
            print("Aquila Cyber salutes your precision! Now exploit the privilege escalation.")
...
def host_eight():
    ...
    while True:
        ...
        if user_input.strip() == cmd1:
            ...
            print("Aquila Cyber salutes your precision! Now read the content of the file.")
...
def host_eighty_three():
    ...
    while True:
        ...
        user_input1 = input("aquila@raven:~$ ")
        user_input2 = input(">>> ")
...
def host_ninety():
    ...
    while True:
        ...
        user_input1 = input("aquila@raven:~$ ")
        user_input2 = input("aquila@raven:~$ ")
        if user_input1.strip() == cmd1 and user_input2.strip() == cmd2:
...
def host_ninety_six():
    ...
    while True:
        ...
        user_input1 = input("aquila@raven:~$ ")
        user_input2 = input("aquila@raven:~$ ")
        user_input3 = input("aquila@raven:~$ ")
...
def host_one_hundred():
    ...
    while True:
        ...
        if user_input1.strip() == cmd1:
            ...
            print(Fore.RED + "Access Denied by Aquila Cyber! Refine Your Tactics!\\n" + Style.RESET_ALL)
            continue
        ...
        user_input_final = input("aquila@raven:~$ ")
